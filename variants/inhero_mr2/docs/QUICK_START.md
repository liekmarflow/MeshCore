...
- The 0.05C ceiling holds for as long as the override is on and can sit well below the calculated solar `imax`: a 4000 mAh pack allows 200 mA, whereas the rule of thumb gives about 650 mA for a 2 W panel with Li-ion 1S (3.7 V).
